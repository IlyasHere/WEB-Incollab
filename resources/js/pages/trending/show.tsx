                            ...
                            <section className="rounded-[28px] border border-[#F0E5FB] bg-white p-5 shadow-[0_16px_38px_rgba(177,145,221,0.14)]">
                                ...
                                <div className="mt-4 space-y-3">
                                    {trendingTopics.map((trendingTopic) => {
                                        const isActive =
                                            trendingTopic.slug === topic.slug;

                                        return (
                                            <Link
                                                key={trendingTopic.slug}
                                                href={`/trending/${trendingTopic.slug}`}
                                                className={`block rounded-2xl px-4 py-3 transition ${
                                                    isActive
                                                        ? 'bg-[#F7F1FF]'
                                                        : 'border border-[#F2E8FA] hover:border-[#D8C4F0] hover:bg-[#FBF7FF]'
                                                }`}
                                            >
