                ...
                <div className="mx-auto max-w-[1320px]">
                    <section className="rounded-[30px] border border-white/70 bg-white p-6 shadow-[0_20px_50px_rgba(177,145,221,0.16)] sm:p-8">
                        ...
                        <p className="mt-3 max-w-2xl text-[16px] leading-8 text-[#5A516C]">
                            Halaman ini disiapkan sebagai placeholder untuk preferensi akun, notifikasi, dan pengaturan aplikasi.
                        </p>
                    </section>
                </div>
            </main>
...
Pengaturan.layout = (page: ReactNode) => <DashboardLayout>{page}</DashboardLayout>;
