    ...
    return (
        <aside className="hidden h-screen shrink-0 border-r border-[#EFE4F8] bg-white md:sticky md:top-0 md:flex md:w-[96px] md:flex-col lg:w-[250px]">
            ...
            <div className="flex flex-1 flex-col px-3 py-6 lg:px-4">
                ...
                <button
                    type="button"
                    className="mt-auto flex h-12 items-center justify-center gap-2 rounded-2xl bg-[#6610F2] px-4 text-sm font-semibold text-white shadow-[0_16px_28px_rgba(102,16,242,0.28)] transition hover:brightness-105 md:px-0 lg:px-4"
                >
